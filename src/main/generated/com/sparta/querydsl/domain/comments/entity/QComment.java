...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = 1019002807L;
    ...
    public final com.sparta.querydsl.domain.posts.entity.QPost post;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.sparta.querydsl.domain.posts.entity.QPost(forProperty("post"), inits.get("post")) : null;
